        ...
        if(event.equals("Submit"))
        {
             ...
             else
            {
                 try
                  ...
                  String insert = db.Insert("insert into user_signup(fname,lname,dob,mob,email,pass,conf)values('"+fname.toString()+"','"+lname.toString()+"','"+dob.toString()+"','"+mob.toString()+"','"+email.toString()+"','"+pass.toString()+"','"+conf.toString()+"')");
                  out.println(insert);
