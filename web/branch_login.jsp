    ...
    <body class="bd">
      ...
      <nav>
        ...
        <div class="form">
            ...
            <h1 class="page">Branch Login</h2>
            
            <form method="post" action="branch_login">
                
            <h2 class="page1">Contact No:</h2>
            <input class="box1"   name="email" placeholder="" onkeypress="return isContactno(event)">
