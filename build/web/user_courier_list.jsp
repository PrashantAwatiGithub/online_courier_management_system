...
.flat-table {
  ...
  <tbody>
    <tr>
     ...
     <% 
        ...
        String sql="select * from user_courier_information ";
  ...
  %>  
  <form method="post" action="user_courier_list">
    <tr>
     ...
     <td><a href="user_courier_details.jsp"><input type="submit" name="submit" value="Details"></a></td>
     <td><a herf="user_tracking_view.jsp"><input type="submit" name="submit" value="Track"></a></td>
    </tr>
