<%-- 
    Document   : branch_courier_details
    Created on : 19 Feb, 2022, 11:36:42 PM
    Author     : Ashvagandha
--%>
...
<html>
    <head>
        ...
        <title>branch_courier_details</title>
    </head>
          ...
          .footer
{
    ...
    <body class="bd">
      ...
      <nav>
        ...
        <ul>
          <li><a href="branch_home_page.jsp">Home</a></li>
          <li><a href="branch_courier_list.jsp">Courier List</a></li>
          <li><a href="branch_courier_details.jsp">Courier Details</a></li>
          <li><a href="branch_login.jsp">Logout</a></li>
